...
} elseif (empty($quantidade) || !is_numeric($quantidade) || $quantidade > 3) {
    echo "A quantidade deve ser preenchida com um número válido e não pode ser maior que 3."; // Resposta simples
} else {
